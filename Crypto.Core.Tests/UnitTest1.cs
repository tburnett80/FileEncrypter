...
namespace Crypto.Core.Tests
{
    ...
    public class UnitTest1 : TestBaseClass
    {
        ...
        [TestMethod]
        public async Task AsymmetricCryptoEndToEndTest()
        {
            //Arrange
            ...
            //Act
            var keys = await eng.GenerateAsymmetricKeys(1024);
        ...
        [TestMethod]
        public async Task EndToEndBytes()
        {
            //Arrange
            ...
            //Act
            var keys = await mgr.GenerateAsymmetricKeys(1024);
